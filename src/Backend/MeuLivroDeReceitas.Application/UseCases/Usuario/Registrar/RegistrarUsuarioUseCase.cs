...
public class RegistrarUsuarioUseCase : IRegistrarUsuarioUseCase
{
    ...
    public RegistrarUsuarioUseCase(IUsuarioWriteOnlyRepositorio repositorio, IMapper mapper, 
        IUnidadeDeTrabalho unidadeDeTrabalho, EncriptadorDeSenha encriptadorDeSenha, TokenContoller tokenController,
    ...
    public async Task<RespostaUsuarioRegistradoJson> Executar(RequisicaoRegistrarUsuarioJson requisicao)
    {
        ...
        entidade.Senha = _encriptadorDeSenha.Criptografia(requisicao.Senha);

        await _repositorio.Adcionar(entidade);
